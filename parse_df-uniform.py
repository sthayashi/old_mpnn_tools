...
invalid_atom_types = ["Si", "Se", "Te", "B", "As"]

min_num_atoms = 10
max_num_atoms = 60
desired_molecule_sizes = np.unique(np.linspace(min_num_atoms, max_num_atoms, dtype=int))
n_samples_per_molecule_size = 10
...
with h5py.File("parsed_molecules.h5", 'w') as file_out:
    for i in range(len(df_chunk)):
        ...
        # Si, Se, Te, B doesn't work with pdynamo
        if 14 in atomic_numbers or 34 in atomic_numbers or 52 in atomic_numbers or 5 in atomic_numbers or 33 in atomic_numbers:
